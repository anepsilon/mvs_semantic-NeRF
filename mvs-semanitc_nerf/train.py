...
import imageio
from scannet.scannet_datasets import dataset_dict
...
class MVS_Semantic_System(LightningModule):
    def __init__(self, args):
        super(MVS_Semantic_System, self).__init__()
        self.args = args
...
if __name__ == '__main__':
    ...
    args = config_parser()
    system = MVS_Semantic_System(args)
